		...
		public Pong() {
			...
			addKeyListener(new KeyListener() {
			    ...
			    public void keyPressed(KeyEvent e) {
			        ...
			        if (key == KeyEvent.VK_W) { wPressed = true; }      // Actualiza los booleanos de las teclas cuando están presionadas.
			    ...
			    public void keyReleased(KeyEvent e) {
			        ...
			        if (key == KeyEvent.VK_W) { wPressed = false; }     // Actualiza las banderas cuando una tecla es soltada.
			...
			Timer timer = new Timer(1, new ActionListener(){ // Se utiliza un timer para que la pelota se pueda mover constantemente.
